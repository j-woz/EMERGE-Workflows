...
* MPICH: `/lus/flare/projects/EpiCalib/sfw/mpich-5.0.0rc3`
* ExaEpi: `/lus/flare/projects/EpiCalib/sfw/ExaEpi_vanilla_2026-03-26`
** Data: A path-consistent copy of the example data is here too
...
.. `configure` with `--with-ze=no` to avoid hwloc problems in `yaksa`
...
This workflow uses GNU Parallel for single-node multi-GPU execution.  On Aurora, we should be able to run at least 24 concurrent simulations.
